 ...
 * user login action.
 */
export const loginAction: ActionFunction1<IUserLoginModel,
  Action<Promise<boolean>>> = createAction(
  USER_LOGGED_IN,
...
export const registerAction: ActionFunction1<IUserRegisterModel, Action<Promise<void>>> = createAction(
  USER_REGISTERED,
  async (data: IUserRegisterModel
  ) => {
    try {
